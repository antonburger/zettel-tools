...
export function activate(context: vscode.ExtensionContext) {
    const serverOptions: ServerOptions = {
        command: "C:\\Users\\Anton\\Code\\zettel-language-server\\zettel-language-server\\bin\\Debug\\netcoreapp3.1\\zettel-language-server.exe"
,
    ...
    client = new LanguageClient("zettelkastenTools", "Zettelkasten Tools", serverOptions, clientOptions);

    client.start();

    context.subscriptions.push(vscode.languages.registerDefinitionProvider('markdown', new NoteDefinitionProvider()));
